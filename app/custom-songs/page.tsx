...
export default function CustomSongsHome() {
  ...
  return (
    ...
    >
      <div style={grid}>
        {/* ONLY CTA: Start My Song Request */}
        <div style={card}>
          <h3 style={h}>Start a Custom Song</h3>
          <p style={p}>
            Tell me the occasion and the story. We’ll shape the lyrics and vibe together — and you can choose audio-only or
            a Photo Music Video package on the next page.
          </p>
